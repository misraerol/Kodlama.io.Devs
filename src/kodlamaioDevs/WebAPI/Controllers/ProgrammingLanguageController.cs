...
namespace WebAPI.Controllers
{
    ...
    public class ProgrammingLanguageController : BaseController
    {
        ...
        {
            CreatedProgrammingLanguageDto createdLanguage = await Mediator.Send(createProgrammingLanguageCommand);
            return Created("", createdLanguage);
        }

        [HttpPut]
        public async Task<IActionResult> Update([FromBody] UpdateProgrammingLanguageCommand updateProgrammingLanguageCommand)
        {
            UpdatedProgrammingLanguageDto updatedLanguage = await Mediator.Send(updateProgrammingLanguageCommand);
        ...
        {
            DeletedProgrammingLanguageDto deletedLanguage = await Mediator.Send(deleteProgrammingLanguageCommand);
